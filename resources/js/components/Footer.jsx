...
const Footer = () => {
    return (
        <footer className="w-full bg-[#F2F3F5] pb-5">
            <hr className="mb-4" />
            <div className="page-container flex max-w-[1220px] flex-col gap-8 min-[426px]:flex-row min-[426px]:items-start min-[426px]:justify-between">
                <a href="/">
                    <img src="/img/logo_footer.svg" alt="инпроком" className="h-14 w-auto min-[426px]:h-[72px]" />
                </a>
                <div className="text-[16px] leading-7 min-[426px]:text-[18px]">
                    <p>
                        Россия, г.Балакирево,
                        <br />
                        ул. Заводская, 10.{" "}
                    </p>
                    <p className="mt-3 min-[426px]:mt-4">info@inprokom.ru</p>
                </div>
                <div className="text-[16px] leading-7 min-[426px]:text-[18px]">
                    <p>+7 49244 7 75 34</p>
                    <p className="mt-3 min-[426px]:mt-4">+7 49244 7 46 85</p>
                </div>
                <button
                    type="button"
                    onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
                    className="shape-fill scale-75 self-start"
                    aria-label="Наверх"
                >
            ...
            <div className="page-container mt-6 flex max-w-[1220px] flex-col gap-4 min-[426px]:mt-2 min-[426px]:flex-row min-[426px]:items-center min-[426px]:justify-between">
                <p className="text-[15px] min-[426px]:text-[18px]">© НПП ИНПРОКОМ 2026</p>
                <a
                    href="/contacts"
                    className="btn-fill flex h-[48px] w-full max-w-[200px] items-center justify-center text-[14px] min-[426px]:h-[52px] min-[426px]:w-[172px]"
                >
