                ...
                {paginatedItems.length > 0 ? (
                    paginatedItems.map((item) => (
                        ...
                        >
                            ...
                            >
                                <form action={statusAction(item.id)} method="POST" className="flex items-center gap-2">
...
function ManagerInbox() {
    const feedback = Array.isArray(window.managerFeedback) ? window.managerFeedback : [];
    const vacancies = Array.isArray(window.managerVacancyApplications) ? window.managerVacancyApplications : [];
        ...
        <main className="mx-auto w-full max-w-[1360px] px-6 py-10">
            ...
            <div className="mt-8 space-y-8">
                <InboxSection
                    ...
                    items={feedback}
                    type="feedback"
                    statusAction={(id) => `/manager/feedback/${id}`}
                ...
                <InboxSection
                    ...
                    items={vacancies}
                    type="vacancy"
                    statusAction={(id) => `/manager/vacancy-applications/${id}`}
